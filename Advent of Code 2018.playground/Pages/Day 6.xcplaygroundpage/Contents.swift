...
let testPoints = test.compactMap(Point.init)

let test1 = part1(testPoints)
assert(test1 == 17)

let input = getInput()
let lines = input.components(separatedBy: .newlines)
let points = lines.compactMap(Point.init)
 ...
 */
let test2 = part2(testPoints, limit: 32)
assert(test2 == 16)

let answer2 = part2(points, limit: 10_000)
