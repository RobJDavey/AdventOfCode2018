 ...
 */
let examplePolymer1 = Polymer("dabAcCaCBAcCcaDA")
let test1 = part1(examplePolymer1)
assert(test1 == 10)

let input = getInput()
let polymer = Polymer(input)

let answer1 = part1(polymer)
 ...
 */
let examplePolymer2 = Polymer("dabAcCaCBAcCcaDA")
let test2 = part2(examplePolymer2)
assert(test2 == 4)

let answer2 = part2(polymer)
