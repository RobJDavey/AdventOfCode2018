...
let testInputItems = testInput.components(separatedBy: .whitespaces)
let testRootNode = Node(testInputItems)

let test1 = testRootNode.part1()
assert(test1 == 138)

let inputItems = getInput().components(separatedBy: .whitespaces)
let rootNode = Node(inputItems)

let answer1 = rootNode.part1()
 ...
 */
let test2 = testRootNode.part2()
assert(test2 == 66)

let answer2 = rootNode.part2()
